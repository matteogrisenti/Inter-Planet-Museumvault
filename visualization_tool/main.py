...
def run_visualization(input_dir: Path, output_dir: Path, mode: str, max_steps_limit: int = None):
    ...
    try:
        ...
        if mode == '1':
            ...
            # We run this as a subprocess so it doesn't block or crash the main thread context
            # Assuming python3 is in path
...
def main():
    ...
    # Output path is relative to the input folder to keep things organized
